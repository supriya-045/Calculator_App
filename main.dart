  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Calculator',
          style: TextStyle(color: Color(0xFFE77330)),
        ),
        backgroundColor: Colors.white,
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                calcbutton('AC', Colors.white, Colors.orange[900]),
                calcbutton('+/-', Colors.white, Colors.orange[900]),
                calcbutton('%', Colors.white, Colors.orange[900]),
                calcbutton('/', Colors.white, Colors.orange[900]),
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('x', Colors.white, Colors.orange[900]),
              ],
            ),
            SizedBox(
              height: 2,
            ...
            Row(
              ...
              children: <Widget>[
                //this is button Zero
                RaisedButton(
                  padding: EdgeInsets.fromLTRB(25, 10, 125, 20),
                  onPressed: () {
                    calculation('0');
                  },
                  shape: StadiumBorder(),
